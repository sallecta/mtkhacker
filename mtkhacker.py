...
info = mtkhacker_meta.name + " V"+ mtkhacker_meta.version+" (fork of MTK Flash/Exploit Client V1.6.1 (c) B.Kerler 2018-2023)"

cmds = {
    "gpt_2": "in development",
...
if __name__ == '__main__':
    ...
    #
    parser_gpt_2 = subparsers.add_parser("gpt_2", help="in development. GPT operations.")
    parser_gpt_2.add_argument('action', help='in development, print GPT')
    #
