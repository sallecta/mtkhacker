...
class MTKH_logger:
	...
	def info(arg_msg, arg_opt=None):
		...
		l = frameinfo.lineno
		this=MTKHacker_logger
		if arg_opt == 'sameline':
			print(f"{this.cyan}{n}:info:{this.end}{f}[{l}]: {arg_msg}", end='\r')
		else:
			print(f"\n{this.cyan}{n}:info{this.end}:{f}[{l}]: \n  {arg_msg}\n")
		sys.stdout.flush()
	...
	def debug(arg_msg, arg_opt=None):
		...
		l = frameinfo.lineno
		this=MTKHacker_logger
		print(f"\n{this.magenta}{n}:debug{this.end}:{f}[{l}]: \n  {arg_msg}\n")
		sys.stdout.flush()
	...
	def warning(arg_msg, arg_opt=None):
		...
		l = frameinfo.lineno
		this=MTKHacker_logger
		print(f"\n{this.yellow}{n}:warning{this.end}:{f}[{l}]: \n  {arg_msg}\n")
		sys.stdout.flush()
	...
	def critical(arg_msg, arg_opt=None):
		...
		l = frameinfo.lineno
		this=MTKHacker_logger
		print(f"\n{this.redbold}{n}:critical{this.end}:{f}[{l}]: \n  {arg_msg}\n")
		sys.stdout.flush()
