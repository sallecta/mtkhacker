...
class DAconfig:
    def __init__(self, mtk, loader=None, preloader=None):
        self.mtk = mtk
        self.path = MTKH_path()
        ...
        if loader is None:
            loaders = []
            for root, dirs, files in os.walk(self.path.loaders, topdown=False):
                for file in files:
...
if __name__ == "__main__":
    ...
    dac.extract_emi("/please/fix/me/mtkclient_github/preloader_meizu6795_lwt_l1.bin")
